...
class Blueprint extends BaseBlueprint
{
	 ...
	 */
	public
	function primaryMuid ( $column = 'muid', $name = NULL, $algorithm = NULL )
	{
	 ...
	 */
	public
	function foreignMuid ( $column = 'muid' )
	{
	 ...
	 */
	public
	function nullableMuidMorphs ( $name, $indexName = NULL )
	{
		$this->string( "{$name}_type" )
		     ->nullable();
