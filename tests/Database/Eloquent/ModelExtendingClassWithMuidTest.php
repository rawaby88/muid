...
class ModelExtendingClassWithMuidTest extends TestCase
{
	/** @test */
	public
	function it_generate_a_muid_when_the_id_has_not_been_set ()
	{
	...
	/** @test */
	public
	function it_generate_a_muid_without_collusion ()
	{
		for ( $i = 0; $i < 10000; $i++ )
		{
	...
	/** @test */
	public
	function it_generate_a_primaryMuid_when_the_id_has_not_been_set ()
	{
	...
	/** @test */
	public
	function it_generate_a_foreignMuid_when_the_id_has_not_been_set ()
	{
	...
	/** @test */
	public
	function it_through_query_exception_if_foreign_key_does_not_exists ()
	{
	...
	/** @test */
	public
	function it_generate_a_muidMorph_type_and_id ()
	{
		$main       = ModelWithMuidExtendsTest::create( [ 'name' => 'Mood' ] );
